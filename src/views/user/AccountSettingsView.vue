                ...
                <div class="flex-1">
                    ...
                    <div v-if="activeTab === 'profile'" class="bg-gray-800 rounded-lg shadow">
                        <div class="px-6 py-4 border-b border-gray-700">
                            <h2 class="text-lg font-medium text-gray-200">{{ t("accountSettingsView.profile.title")
                                }}</h2>
                        </div>
                        <div class="p-6">
                    ...
                    <div v-if="activeTab === 'activity'" class="bg-gray-800 rounded-lg shadow">
                        <div class="px-6 py-4 border-b border-gray-700">
                            <h2 class="text-lg font-medium text-gray-200">{{ t("accountSettingsView.activity.title")
                                }}</h2>
