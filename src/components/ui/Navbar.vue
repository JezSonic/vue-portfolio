<script setup lang="ts">
    ...
    const themeDropdownOpen = ref<boolean>(false);
                            ...
                            <div v-if="langDropdownOpen"
                                ...
                                <div v-for="lang in languages" :key="lang.code">
                                    <a href="#" @click.prevent="changeLanguage(lang.code)"
                                       :class="[locale === lang.code ? 'bg-gray-100 outline-hidden' : '', 'block px-4 py-2 text-sm text-gray-700']">
                                        {{ t(lang.name) }}
                            ...
                            <div
                                ...
                                <div>
                                    <a href="#" @click="AuthService.logout()"
                                       class="block px-4 py-2 text-sm text-red-700">{{ t("auth.signOut")
                                        }}</a>
                                </div>
                            </div>
                        </transition>
