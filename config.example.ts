...
export const config: IEnv = {
    ...
    ENABLED_OAUTH_PROVIDERS: [
        EOAuthProvider.Google, //Only Google or GoogleOneTap may be enabled at the same time. Warning: GoogleOneTap is experimental and may not work on all browsers and may not work locally
